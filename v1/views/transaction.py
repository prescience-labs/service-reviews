...
from v1.serializers import (
    ...
    CreateTransactionComprehensiveSerializer,
)
...
class CreateTransactionComprehensive(generics.CreateAPIView):
    ...
    """
    serializer_class = CreateTransactionComprehensiveSerializer

    def post(self, request):
        serializer  = CreateTransactionComprehensiveSerializer(data=request.data)
